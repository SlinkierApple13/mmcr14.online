...
export class Display extends Container {
  ...
  addText(
    ...
    const fontFamily = simfang
      ? 'CmuSerif, GameFangsong, sans-serif'
      : 'CmuSerif, GameKai, sans-serif'
...
export class Countdown extends Container {
  ...
  constructor(parent: Container) {
    ...
    this.timeText = new Text({
      text: '\u2212',
      style: { fontFamily: 'CmuSerif, GameFangsong, sans-serif', fontSize: 270, fill: 0x000000, align: 'center' },
    })
...
export class DirLabel extends Container {
  ...
  constructor(parent: Container, localDir = 0, assocWaitDisplay: WaitDisplay | null = null) {
    ...
    this.dirText = new Text({
      text: '',
      style: { fontFamily: 'CmuSerif, GameFangsong, sans-serif', fontSize: 330, fill: 0x000000, align: 'center' },
    })
